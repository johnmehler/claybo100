export const games = [
	{ 
		...
		keywords: [
			...
			'15 puzzle game for children',
			'brain teaser sliding tiles',
			'kids logic training games',
			'fun sliding puzzles for students',
			'classic tile sorting game'
		],
	...
	{ 
		...
		keywords: [
			'critical thinking games for 10 year olds',
			'peg solitaire online for kids',
			'classic pegboard puzzle',
			'solitaire board game for children',
			'brain training peg game',
			'strategy puzzles for elementary students',
			'mental math and logic peg game'
		],
	...
	{ 
		...
		keywords: [
			'fun tower of hanoi game for kids',
			'tower of hanoi online simulator',
			'recursive puzzles for children',
			'math logic tower game',
			'brain training disc puzzle',
			'educational math challenges for students',
			'classic hanoi tower for elementary school'
		],
	...
	{ 
		...
		keywords: [
			'fun logic puzzles for elementary students',
			'knights tour chess puzzle online',
			'chess strategy games for kids',
			'logic grid puzzles for children',
			'brainy chess challenges',
			'math museum chess puzzles',
			'critical thinking knight game'
		],
	...
	{ 
		...
		cardClass: 'set-card',
		keywords: [
			'cool math brain games online',
			'set card game for kids online',
			'pattern recognition games for children',
			'visual logic puzzles for students',
			'brain training set game',
			'math logic card puzzles',
			'educational games for gifted kids'
		],
	...
	{ 
		...
		cardClass: 'dots-card',
		keywords: [
			'kids board games to play online',
			'dots and boxes game against AI',
			'classic pencil and paper games online',
			'strategy board games for children',
			'square capturing logic game',
			'fun competitive games for kids',
			'interactive dots and boxes simulator'
		],
	...
	{ 
		...
		cardClass: 'ice-card',
		keywords: [
			'safe educational game sites for kids',
			'ice slider puzzle game online',
			'frictionless physics puzzles',
			'logic sliding games for children',
			'sokoban style games for kids',
			'challenging ice puzzles for students',
			'brainy block sliding adventures'
		],
	...
	{ 
		...
		cardClass: 'nim-card',
		keywords: [
			'math strategy games for middle school',
			'nim game online for kids',
			'mathematical game theory for children',
			'strategic removal games',
			'binary math games for students',
			'logic puzzles for 6th graders',
			'competitive math strategy simulator'
		],
	...
	{ 
		...
		cardClass: 'hex-card',
		keywords: [
			'memory and strategy games for children',
			'hex board game online',
			'connection games for kids',
			'hexagonal grid strategy',
			'nash equilibrium games for students',
			'logic board games for elementary',
			'brain training hex puzzle'
		],
	...
	{ 
		...
		keywords: [
			'educational math games for 2nd graders',
			'krypto math game online',
			'mental math practice for kids',
			'arithmetic puzzles for children',
			'number sense games for students',
			'math museum card games',
			'fun math fluency exercises'
		],
	...
	{ 
		...
		keywords: [
			'interactive brain teasers for children',
			'projectile motion simulator for kids',
			'physics cannon games online',
			'educational science simulations',
			'trajectory prediction puzzles',
			'gravity and motion games for students',
			'fun physics arcade for kids'
		],
	...
	{ 
		...
		keywords: [
			'math games to make kids smarter',
			'vector racing game online',
			'coordinate geometry games for kids',
			'momentum and velocity physics game',
			'graph paper racing simulator',
			'logic racing for students',
			'educational vector math puzzles'
		],
	...
	{ 
		...
		keywords: [
			'fun problem solving games for students',
			'brachistochrone curve simulator',
			'galileo physics experiments for kids',
			'fastest descent path puzzle',
			'educational gravity simulations',
			'science museum online games',
			'interactive physics tracks'
		],
	...
	{ 
		...
		keywords: [
			'online brain training for kids',
			'lunar lander physics game',
			'space mission simulator for children',
			'thrust and gravity logic game',
			'educational space exploration games',
			'moon landing simulator for students',
			'challenging flight puzzles'
		],
	...
	{ 
		...
		keywords: [
			'interactive brain teasers for children',
			'virus spread simulator for schools',
			'epidemiology games for kids',
			'social distancing math models',
			'educational health simulations',
			'population dynamic puzzles',
			'science modeling for students'
		],
