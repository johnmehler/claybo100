...
<style>
	...
	h2 { color: var(--app-text); font-size: 4vmin; margin: 0; font-weight: 900; letter-spacing: 0.2vmin; text-transform: uppercase; }
	...
	.play-btn { background: var(--app-text); color: var(--app-bg); border: none; padding: 1.5vmin 4vmin; border-radius: 1vmin; font-size: 2.2vmin; font-weight: 900; cursor: pointer; transition: filter 0.2s; }
