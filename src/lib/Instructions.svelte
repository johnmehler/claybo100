...
<style>
	.overlay { position: absolute; inset: 0; background: rgba(0,0,0,0.85); backdrop-filter: blur(10px); display: flex; align-items: center; justify-content: center; z-index: 1000; color: white; }
	.modal { background: #18181b; border: 2px solid rgba(255,255,255,0.1); border-radius: 3vmin; padding: 5vmin; max-width: 70vmin; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 4vmin; box-shadow: 0 20px 40px rgba(0,0,0,0.8); }
	...
	.content { font-size: 2.2vmin; color: rgba(255,255,255,0.8); line-height: 1.6; text-align: left; width: 100%; display: flex; flex-direction: column; gap: 2vmin; }
